...
pause on
set type double 
cd "/Users/michaeldarden/Dropbox/Research/Cost_shifting/Darden_McCarthy_HRRP/Analysis"
/*
*set paths*
...
by provider_number: egen everpen=max(net_penalty)
...
foreach y of global DIS_OUTCOMES{
qui: reghdfe `y' amt_penalty i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0) , absorb(provider_number) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' amt_penalty  i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0), absorb(provider_number) cluster(provider_number)
est store h_`y'
}
esttab h_ln_mcaid_discharges h_ln_mcare_discharges h_ln_total_discharges h_ln_other_discharges h_pindex h_lnprice  h_lnprice_hcci, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
est clear
...
**** Now Penalty Amount conditional on (everpen==1 & amt_penalty>=0)
foreach y of global DIS_OUTCOMES{
qui: reghdfe `y' amt_penalty i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6 if (everpen==1 & amt_penalty>=0), absorb(provider_number) cluster(provider_number)
est sto h_trend_`y'
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty=r(p)
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' amt_penalty  i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6 if (everpen==1 & amt_penalty>=0), absorb(provider_number) cluster(provider_number)
est sto h_trend_`y'
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty=r(p)
}
...
**** Start by looking at just net_penalty
foreach y of global DIS_OUTCOMES{
qui: reghdfe `y' net_penalty i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6  if Nonprofit==1, absorb(provider_number) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' net_penalty  i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6  if Nonprofit==1, absorb(provider_number) cluster(provider_number)
est store h_`y'
}
*** Nonprofit
esttab h_ln_mcaid_discharges h_ln_mcare_discharges h_ln_total_discharges h_ln_other_discharges h_pindex h_lnprice  h_lnprice_hcci, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
...
**** Now Penalty Amount conditional on (everpen==1 & amt_penalty>=0)
foreach y of global DIS_OUTCOMES{
qui: reghdfe `y' amt_penalty i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0) & Nonprofit==1, absorb(provider_number) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' amt_penalty  i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0)  & Nonprofit==1, absorb(provider_number) cluster(provider_number)
est store h_`y'
}
*** Nonprofit
esttab h_ln_mcaid_discharges h_ln_mcare_discharges h_ln_total_discharges h_ln_other_discharges h_pindex h_lnprice h_lnprice_hcci, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
...
****Now the same with variable trends:
foreach y of global DIS_OUTCOMES{
qui: reghdfe `y' net_penalty i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6 if Nonprofit==1, absorb(provider_number) cluster(provider_number)
est sto h_trend_`y'
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty=r(p)
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' net_penalty  i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6 if Nonprofit==1, absorb(provider_number) cluster(provider_number)
est sto h_trend_`y'
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty=r(p)
}
...
**** Now Penalty Amount conditional on (everpen==1 & amt_penalty>=0)
foreach y of global DIS_OUTCOMES{
qui: reghdfe `y' amt_penalty i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6 if (everpen==1 & amt_penalty>=0) & Nonprofit==1, absorb(provider_number) cluster(provider_number)
est sto h_trend_`y'
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty=r(p)
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' amt_penalty  i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6 if (everpen==1 & amt_penalty>=0) & Nonprofit==1, absorb(provider_number) cluster(provider_number)
est sto h_trend_`y'
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty=r(p)
}
...
**** Start by looking at just net_penalty
foreach y of global DIS_OUTCOMES{
qui: reghdfe `y' net_penalty i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6  if Nonprofit==0, absorb(provider_number) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' net_penalty  i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6  if Nonprofit==0, absorb(provider_number) cluster(provider_number)
est store h_`y'
}
*** FORprofit
esttab h_ln_mcaid_discharges h_ln_mcare_discharges h_ln_total_discharges h_ln_other_discharges h_pindex h_lnprice  h_lnprice_hcci, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
...
**** Now Penalty Amount conditional on (everpen==1 & amt_penalty>=0)
foreach y of global DIS_OUTCOMES{
qui: reghdfe `y' amt_penalty i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0) & Nonprofit==0, absorb(provider_number) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' amt_penalty  i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0)  & Nonprofit==0, absorb(provider_number) cluster(provider_number)
est store h_`y'
}
*** FORprofit
esttab h_ln_mcaid_discharges h_ln_mcare_discharges h_ln_total_discharges h_ln_other_discharges h_pindex h_lnprice  h_lnprice_hcci, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
...
****Now the same with variable trends:
foreach y of global DIS_OUTCOMES{
qui: reghdfe `y' net_penalty i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6 if Nonprofit==0, absorb(provider_number) cluster(provider_number)
est sto h_trend_`y'
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty=r(p)
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' net_penalty  i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6 if Nonprofit==0, absorb(provider_number) cluster(provider_number)
est sto h_trend_`y'
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty=r(p)
}
...
**** Now Penalty Amount conditional on (everpen==1 & amt_penalty>=0)
foreach y of global DIS_OUTCOMES{
qui: reghdfe `y' amt_penalty i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6 if (everpen==1 & amt_penalty>=0) & Nonprofit==0, absorb(provider_number) cluster(provider_number)
est sto h_trend_`y'
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty=r(p)
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' amt_penalty  i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6 if (everpen==1 & amt_penalty>=0) & Nonprofit==0, absorb(provider_number) cluster(provider_number)
est sto h_trend_`y'
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty=r(p)
}
...
**** Now Penalty Amount conditional on (everpen==1 & amt_penalty>=0)
foreach y of global DIS_OUTCOMES{
qui: reghdfe `y' amt_penalty i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0), absorb(provider_number fips) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' amt_penalty  i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0), absorb(provider_number fips) cluster(provider_number)
est store h_`y'
}
esttab h_ln_mcaid_discharges h_ln_mcare_discharges h_ln_total_discharges h_ln_other_discharges h_pindex h_lnprice  h_lnprice_hcci, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
est clear
...
**** Now Penalty Amount conditional on (everpen==1 & amt_penalty>=0)
foreach y of global DIS_OUTCOMES{
qui: reg `y' amt_penalty i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0),  cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
qui: reg `y' amt_penalty  i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0),  cluster(provider_number)
est store h_`y'
}
esttab h_ln_mcaid_discharges h_ln_mcare_discharges h_ln_total_discharges h_ln_other_discharges h_pindex h_lnprice  h_lnprice_hcci, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
est clear
...
**** Now Penalty Amount conditional on (everpen==1 & amt_penalty>=0)
foreach y of global DIS_OUTCOMES{
qui: reghdfe `y' amt_penalty  expand i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0), absorb(provider_number) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' amt_penalty  expand i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0), absorb(provider_number) cluster(provider_number)
est store h_`y'
}
esttab h_ln_mcaid_discharges h_ln_mcare_discharges h_ln_total_discharges h_ln_other_discharges h_pindex h_lnprice  h_lnprice_hcci, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
est clear
...
**** Now Penalty Amount conditional on (everpen==1 & amt_penalty>=0)
foreach y of global DIS_OUTCOMES{
qui: reghdfe `y' amt_penalty hcahps_rating i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0), absorb(provider_number) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' amt_penalty hcaphs_rating i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0), absorb(provider_number) cluster(provider_number)
est store h_`y'
}
esttab h_ln_mcaid_discharges h_ln_mcare_discharges h_ln_total_discharges h_ln_other_discharges h_pindex h_lnprice  h_lnprice_hcci, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
est clear
...
**** Now Penalty Amount conditional on (everpen==1 & amt_penalty>=0)
foreach y of global DIS_OUTCOMES{
qui: reghdfe `y' amt_penalty i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0) &  never_vi==1, absorb(provider_number) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' amt_penalty  i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0) &  never_vi==1, absorb(provider_number) cluster(provider_number)
est store h_`y'
}
esttab h_ln_mcaid_discharges h_ln_mcare_discharges h_ln_total_discharges h_ln_other_discharges h_pindex h_lnprice  h_lnprice_hcci, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
est clear
...
**** Now Penalty Amount conditional on (everpen==1 & amt_penalty>=0)
foreach y of global DIS_OUTCOMES{
qui: reghdfe `y' amt_penalty i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0) &  Year<2014, absorb(provider_number) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' amt_penalty  i.fips_power i.fips_size   ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0) &  Year<2014, absorb(provider_number) cluster(provider_number)
est store h_`y'
}
esttab h_ln_mcaid_discharges h_ln_mcare_discharges h_ln_total_discharges h_ln_other_discharges h_pindex h_lnprice  h_lnprice_hcci, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
est clear
...
preserve
	...
	*Baseline Model
    ...
    est clear
	qui: reghdfe lnprice_hcci_`d' amt_penalty  i.fips_power i.fips_size  ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 if (everpen==1 & amt_penalty>=0), absorb(provider_number) cluster(provider_number)
	est store h_lnprice_hcci_`d'
	esttab h_lnprice_hcci_`d', b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
