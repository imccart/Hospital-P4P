set logtype text
cd "E:"
global DATA_HCRIS "C:\Users\immccar\Professional\Research Data\Hospital Cost Reports\Final HCRIS Data\"
...
by Year zip, sort: egen Market_Discharges=total(total_discharges)
...
collapse (sum) total_discharges HHI_Discharge=discharge_share2 TotalBeds=beds (count) Hospitals=provider_number, by(zip Year)
