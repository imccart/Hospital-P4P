...
reghdfe `y' pen_both pen_one $POWER  ${MKT} ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6, absorb(provider_number fips) cluster(provider_number)
est store h_`y'
}
...
esttab h_medicaid_share h_medicare_share h_public_share h_other_share h_pindex h_lnprice, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) keep(pen_both pen_one $MKT $HOSPITAL_VARS $PRICE_VARS)
...
foreach y of global SHARE_OUTCOMES{
reghdfe `y' penalty##i.fips_power_2 penalty##i.fips_power_3 ${MKT} ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6, absorb(provider_number fips) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
reghdfe `y' penalty##i.fips_power_2 penalty##i.fips_power_3 ${MKT}  ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6  if fips_power~=., absorb(provider_number fips) cluster(provider_number)
est store h_`y'
}
...
tab psper, gen(ps)
for num 2/4: gen ps_penX=psX*penalty
foreach y of global PRICE_OUTCOMES{
reghdfe `y' penalty ps2 ps3 ps4 ps_pen* ${POWER} ${MKT}  ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6  if fips_power~=., absorb(provider_number fips) cluster(provider_number)
est store h_`y'
}
esttab h_lnprice, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
est clear
********************************************************************************
*** Table 6: Lagged DD and DDD models 										
********************************************************************************
foreach y of global SHARE_OUTCOMES{
...
foreach y of global SHARE_OUTCOMES{
qui: reghdfe `y' pen_both##i.fips_power_2 pen_both##i.fips_power_3 pen_one##i.fips_power_2 pen_one##i.fips_power_3 l.pen_both##i.fips_power_2 l.pen_both##i.fips_power_3 l.pen_one##i.fips_power_2 l.pen_one##i.fips_power_3 ${MKT} ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6, absorb(provider_number fips) cluster(provider_number)
est store h_`y'2
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' pen_both##i.fips_power_2 pen_both##i.fips_power_3 pen_one##i.fips_power_2 pen_one##i.fips_power_3 l.pen_both##i.fips_power_2 l.pen_both##i.fips_power_3 l.pen_one##i.fips_power_2 l.pen_one##i.fips_power_3 ${MKT}  ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6  if fips_power~=., absorb(provider_number fips) cluster(provider_number)
est store h_`y'2
}
esttab h_medicaid_share1 h_medicare_share1 h_public_share1 h_other_share1 h_pindex1 h_lnprice1 h_medicaid_share2 h_medicare_share2 h_public_share2 h_other_share2 h_pindex2 h_lnprice2  , b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
est clear
foreach y of global SHARE_OUTCOMES{
qui: reghdfe `y' pen_both pen_one l.pen_both l.pen_one $POWER  ${MKT} ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6, absorb(provider_number fips) cluster(provider_number)
est store h_`y'1
...
foreach y of global SHARE_OUTCOMES{
qui: reghdfe `y' pen_both##i.fips_power_2 pen_both##i.fips_power_3 pen_one##i.fips_power_2 pen_one##i.fips_power_3 l.pen_both##i.fips_power_2 l.pen_both##i.fips_power_3 l.pen_one##i.fips_power_2 l.pen_one##i.fips_power_3 l2.pen_both##i.fips_power_2 l2.pen_both##i.fips_power_3 l2.pen_one##i.fips_power_2 l2.pen_one##i.fips_power_3 ${MKT} ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6, absorb(provider_number fips) cluster(provider_number)
est store h_`y'2
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' pen_both##i.fips_power_2 pen_both##i.fips_power_3 pen_one##i.fips_power_2 pen_one##i.fips_power_3 l.pen_both##i.fips_power_2 l.pen_both##i.fips_power_3 l.pen_one##i.fips_power_2 l.pen_one##i.fips_power_3 l2.pen_both##i.fips_power_2 l2.pen_both##i.fips_power_3 l2.pen_one##i.fips_power_2 l2.pen_one##i.fips_power_3 ${MKT}  ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6  if fips_power~=., absorb(provider_number fips) cluster(provider_number)
est store h_`y'2
}
esttab h_medicaid_share1 h_medicare_share1 h_public_share1 h_other_share1 h_pindex1 h_lnprice1 h_medicaid_share2 h_medicare_share2 h_public_share2 h_other_share2 h_pindex2 h_lnprice2  , b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
********************************************************************************
...
foreach y of global SHARE_OUTCOMES{
reghdfe `y' pen_both pen_one $POWER  ${MKT} ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6, absorb(provider_number fips fips#year_trend) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
...
******** DDD with full interactions
** First by Market Share
foreach y of global SHARE_OUTCOMES{
reghdfe `y' pen_one##i.fips_power_2 pen_one##i.fips_power_3 pen_both##i.fips_power_2 pen_both##i.fips_power_3 ${MKT} ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6, absorb(provider_number fips) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
reghdfe `y' pen_one##i.fips_power_2 pen_one##i.fips_power_3 pen_both##i.fips_power_2 pen_both##i.fips_power_3 ${MKT}  ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6  if fips_power~=., absorb(provider_number fips) cluster(provider_number)
est store h_`y'
}
esttab h_medicaid_share h_medicare_share h_public_share h_other_share h_pindex h_lnprice, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
est clear
...
foreach y of global PRICE_OUTCOMES{
reghdfe `y' pen_one pen_both ps2 ps3 ps4 ps_one* ps_both* ${POWER} ${MKT}  ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6  if fips_power~=., absorb(provider_number fips) cluster(provider_number)
est store h_`y'
}
esttab h_lnprice, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
est clear
drop ps*
********* Specifications without county FE
*** First table 3
foreach y of global SHARE_OUTCOMES{
reghdfe `y' pen_both pen_one $POWER  ${MKT} ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6, absorb(provider_number) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' pen_both pen_one  $POWER ${MKT}  ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6, absorb(provider_number) cluster(provider_number)
est store h_`y'
}
esttab h_medicaid_share h_medicare_share h_public_share h_other_share h_pindex h_lnprice, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) keep(pen_both pen_one $MKT $HOSPITAL_VARS $PRICE_VARS)

foreach y of global SHARE_OUTCOMES{
qui: reghdfe `y' pen_both pen_one  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6  $POWER ${COUNTY_VARS} ${HOSPITAL_VARS} ${MKT} m_*, absorb(provider_number) cluster(provider_number)
est sto h_trend_`y'
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty=r(p)
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' pen_both pen_one  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6   $POWER ${PRICE_VARS} ${COUNTY_VARS} ${HOSPITAL_VARS} ${MKT} m_*, absorb(provider_number) cluster(provider_number)
est sto h_trend_`y'
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty=r(p)
}
...
**** Next Table 4
foreach y of global SHARE_OUTCOMES{
qui: reghdfe `y' pen_both pen_one  $POWER ${MKT} ${COUNTY_VARS} ${HOSPITAL_VARS} m_* y2 y3 y4 y5 y6  if any_forprofit==0, absorb(provider_number) cluster(provider_number)
est store h_`y'_nfp
qui: reghdfe `y' pen_both pen_one  $POWER ${MKT} ${COUNTY_VARS} ${HOSPITAL_VARS} m_* y2 y3 y4 y5 y6  if any_forprofit==1, absorb(provider_number) cluster(provider_number)
est store h_`y'_fp
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' pen_both pen_one  $POWER ${MKT}  ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 if any_forprofit==0, absorb(provider_number) cluster(provider_number)
est store h_`y'_nfp
qui: reghdfe `y' pen_both pen_one  $POWER ${MKT}  ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6 if any_forprofit==1, absorb(provider_number) cluster(provider_number)
est store h_`y'_fp
}
esttab h_medicaid_share_nfp h_medicare_share_nfp h_public_share_nfp h_other_share_nfp h_pindex_nfp h_lnprice_nfp, title("Nonprofit Hospitals") b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
esttab h_medicaid_share_fp h_medicare_share_fp h_public_share_fp h_other_share_fp h_pindex_nfp h_lnprice_fp, title("For-profit Hospitals") b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
foreach y of global SHARE_OUTCOMES{
qui: reghdfe `y' pen_both pen_one  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6  $POWER ${COUNTY_VARS} ${HOSPITAL_VARS} ${MKT} m_* if any_forprofit==0, absorb(provider_number) cluster(provider_number)
est store th_`y'_nfp
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty_nfp=r(p)
qui: reghdfe `y' pen_both pen_one  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6  $POWER ${COUNTY_VARS} ${HOSPITAL_VARS} ${MKT} m_* if any_forprofit==1, absorb(provider_number) cluster(provider_number)
est store th_`y'_fp
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty_fp=r(p)
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' pen_both pen_one  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6  $POWER ${PRICE_VARS} ${COUNTY_VARS} ${HOSPITAL_VARS} ${MKT} m_* if any_forprofit==0, absorb(provider_number) cluster(provider_number)
est store th_`y'_nfp
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty_nfp=r(p)
qui: reghdfe `y' pen_both pen_one  y2 y3 y4 y5 y6 evY2 evY3 evY4 evY5 evY6  $POWER ${PRICE_VARS} ${COUNTY_VARS} ${HOSPITAL_VARS} ${MKT} m_* if any_forprofit==1, absorb(provider_number) cluster(provider_number)
est store th_`y'_fp
qui: test evY2 evY3 evY4 evY5 evY6
scalar `y'_penalty_fp=r(p)
}
...
** First by Market Share
foreach y of global SHARE_OUTCOMES{
reghdfe `y' penalty##i.fips_power_2 penalty##i.fips_power_3 ${MKT} ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6, absorb(provider_number) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
reghdfe `y' penalty##i.fips_power_2 penalty##i.fips_power_3 ${MKT}  ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6  if fips_power~=., absorb(provider_number) cluster(provider_number)
est store h_`y'
}
esttab h_medicaid_share h_medicare_share h_public_share h_other_share h_pindex h_lnprice, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
est clear
...
for num 2/4: gen ps_penX=psX*penalty
foreach y of global PRICE_OUTCOMES{
reghdfe `y' penalty ps2 ps3 ps4 ps_pen* ${POWER} ${MKT}  ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6  if fips_power~=., absorb(provider_number) cluster(provider_number)
est store h_`y'
}
esttab h_lnprice, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
est clear
...
********************************************************************************
*** Table 8: Intensive Margin of HRRP Penalties 										
********************************************************************************
replace adj=1 if year_trend<4
xtile adjcont=adj if adj~=1, n(3)
replace adjcont=0 if adj==1
tab adjcont, gen(psize)
foreach y of global SHARE_OUTCOMES{
qui: reghdfe `y' psize2 psize3 psize4 $POWER  ${MKT} ${COUNTY_VARS} ${HOSPITAL_VARS} m_*  y2 y3 y4 y5 y6, absorb(provider_number fips) cluster(provider_number)
est store h_`y'
}
foreach y of global PRICE_OUTCOMES{
qui: reghdfe `y' psize2 psize3 psize4  $POWER ${MKT}  ${COUNTY_VARS} ${HOSPITAL_VARS} ${PRICE_VARS}  m_*  y2 y3 y4 y5 y6, absorb(provider_number fips) cluster(provider_number)
est store h_`y'
}
esttab h_medicaid_share h_medicare_share h_public_share h_other_share h_pindex h_lnprice, b(%5.3f) se(%5.3f) star(* 0.1 ** 0.05 *** 0.01) 
est clear
